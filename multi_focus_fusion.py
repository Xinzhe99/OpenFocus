...
from fusion_methods.classical.dct import dct_focus_stack_fusion
from fusion_methods.classical.gff import gff_impl
from fusion_methods.deep_learning.stackmffv4 import _stackmffv4_impl
from fusion_methods.classical.dtcwt import dtcwt_impl as _dtcwt_impl
...
class MultiFocusFusion:
    ...
    def _fuse_gfgfgf(self,
        ...
        """
        try:
            from fusion_methods.classical.gfg_fgf import gfgfgf_impl
